"""PyCaret time-series backend adapter."""
...
@BACKEND_REGISTRY.register("pycaret_timeseries")
class PyCaretTimeSeriesBackend(BaseLibraryBackend):
    name = "pycaret_timeseries"
    ...
    def predict(self, model: Any, x_test: Any, **kwargs: Any) -> Any:
        return {"message": "pycaret_timeseries adapter scaffolded", "model": model}
